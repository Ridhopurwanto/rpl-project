...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('gangguan_kamtibmas', function (Blueprint $table) {
            ...
            $table->enum('kategori', ['Curat', 'Curas', 'Curanmor', 'Narkoba', 'Laka Lantas', 'Pembunuhan', 'Perkelahian', 'Mabok', 'Unjuk Rasa', 'Penyerobotan Tanah', 'Kenakalan Remaja', 'Kebakaran', 'Bencana Alam'])->nullable();
            $table->timestamps();
        });
    }
