        ...
        <div class="email-body">
            ...
            <div class="shift-details-card">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="width: 120px; color: #6b7280; font-weight: 500; vertical-align: top;">Status</td>
                        <td style="width: 20px; color: #6b7280; text-align: center; vertical-align: top;">:</td>
                        <td style="color: #111827; font-weight: 600; vertical-align: top;">Diubah</td>
                    </tr>
                </table>
            </div>
            @endif
            ...
            <div class="cta-button-container">
                <a href="{{ route('anggota.presensi.index') }}" class="cta-button">Lihat Jadwal Lengkap</a>
            </div>
        </div>
