...
<div class="hidden md:block overflow-x-auto">
    <table class="w-full min-w-max">
        ...
        <tbody class="text-sm divide-y divide-gray-200">
                    ...
                    @if(Auth::user()->peran == 'supervisor')
                        <td class="py-2 px-4">
                            <div class="flex justify-center space-x-3">
                                <button @click="
                                    showEditModal = true; 
                                    editAction = '{{ route('supervisor.gangguan.update', $gangguan->id_gangguan) }}';
                                ...
                                <button @click.prevent="
                                    ...
                                    deleteAction = '{{ route('supervisor.gangguan.destroy', $gangguan->id_gangguan) }}'
            ...
            @empty
                <tr>
                    <td colspan="{{ Auth::user()->peran == 'supervisor' ? '7' : '6' }}"
                ...
                <div class="flex-1 min-w-0">
                    ...
                    @if(Auth::user()->peran == 'supervisor')
                        <div class="flex gap-1.5">
                            ...
                            <button
                                @click.prevent="showDeleteModal = true; deleteAction = '{{ route('supervisor.gangguan.destroy', $gangguan->id_gangguan) }}'"
