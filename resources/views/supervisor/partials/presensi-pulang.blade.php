    ...
    <div class="hidden md:block overflow-x-auto">
        <table class="w-full min-w-max table-fixed">
            ...
            <tbody class="text-sm divide-y divide-gray-200">
                ...
                <tr>
                    <td class="py-2 px-4">{{ $dataPulang->firstItem() + $index }}.</td>
        ...
        <div class="flex items-center gap-1">
            ...
            @else
                <a href="{{ $dataPulang->appends(request()->query())->previousPageUrl() }}" 
                   ...
                   data-target="pulang">Previous</a>
            @endif

            {{-- Pagination Elements --}}
            @foreach ($dataPulang->links()->elements as $element)
