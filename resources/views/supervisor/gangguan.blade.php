...
{{-- Style untuk animasi timer notifikasi --}}
    ...
    <div class="w-full mx-auto" x-data="{ 
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
            ...
            {{-- Form Filter --}}
            <form id="filterForm" action="{{ route('supervisor.gangguan.index') }}" method="GET"
            ...
            <div id="gangguan-list-wrapper">
                 @include('supervisor.partials.gangguan-list', ['riwayatGangguan' => $riwayatGangguan])
            </div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.fetchData = function(url = null) {
            ...
            if (!url) {
                ...
                url = "{{ route('supervisor.gangguan.index') }}?" + params.toString();
            }
