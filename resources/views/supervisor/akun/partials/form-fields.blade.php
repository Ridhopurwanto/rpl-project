...
<div x-data="{
        ...
        fillForm(data) {
            ...
            if (data.jenis_jadwal) {
                ...
                this.jenis_jadwal = (this.peran === 'supervisor') ? 'non_shift' : 'shift';
            }
    ...
    <div class="p-4 bg-blue-50/50 rounded-xl border border-blue-100">
        ...
        {{-- Password Section --}}
        <div x-show="!{{ $isEdit ? 'true' : 'false' }} || (peran === 'supervisor' || peran === 'anggota' || peran === 'bau')" class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            {{-- Password --}}
            <div>
    ...
    <div class="p-4 bg-white rounded-xl border border-gray-200 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            {{-- Jenis Jadwal --}}
            <div x-show="peran === 'anggota' || peran === 'supervisor'">
