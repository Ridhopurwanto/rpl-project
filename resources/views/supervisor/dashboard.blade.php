...
<div class="w-full">
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        {!! renderMenuButton('PRESENSI', route('supervisor.presensi.index')) !!}
        {!! renderMenuButton('PATROLI', route('supervisor.patroli.index')) !!}
        {!! renderMenuButton('KENDARAAN', route('supervisor.kendaraan.index')) !!}
