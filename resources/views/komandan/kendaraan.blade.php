                            ...
                            <td class="py-2 px-4">
                                <div class="flex justify-center">
                                    {{-- 
                                      ...
                                      1. Jika relasi 'kendaraan' ADA (id_kendaraan != NULL), berarti sudah terdaftar. Tampilkan centang.
                                      2. Jika relasi 'kendaraan' NULL, berarti belum terdaftar. Tampilkan tombol plus.
                                    --}}
                                    @if($log->kendaraan)
                                    ...
                                    @else
                                        {{-- BELUM TERDAFTAR: Tampilkan tombol (+) 'Promote' --}}
