...
<<<<<<< HEAD
        ...
        {{-- MODAL PENGATURAN RULE --}}
        {{-- MODAL PENGATURAN RULE --}}
        <div x-show="showRuleModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75 p-4"
            @click.away="showRuleModal = false" style="display: none;">
=======
    {{-- MODAL EDIT --}}
