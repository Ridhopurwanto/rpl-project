...
<div class="w-full px-4 py-8">
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg mb-6">
        ...
        <div class="flex justify-around items-center">
            ...
            <form action="{{ route('komandan.role.set') }}" method="POST">
                @csrf
                <input type="hidden" name="role" value="anggota">
                
                {{-- Kita ubah <a> menjadi <button> dan berikan style yang sama --}}
                <button type="submit" class="text-center group focus:outline-none">
            ...
            <form action="{{ route('komandan.role.set') }}" method="POST">
                @csrf
                <input type="hidden" name="role" value="komandan">
