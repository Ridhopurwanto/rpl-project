        ...
        <tbody class="text-sm divide-y divide-gray-200">
            @forelse($barangTemuan as $index => $barang)
                <tr>
                    ...
                    <td class="py-2 px-4 text-center">{{ $barang->waktu_lapor->format('d/m/Y') }}</td>
                    ...
                    <td class="py-2 px-4 text-center">
                        <button class="edit-comprehensive-btn text-blue-500 hover:text-blue-700" 
                                ...
                                data-type="temuan"
                                data-tanggal="{{ $barang->waktu_lapor->format('Y-m-d') }}"
                                data-nama-barang="{{ $barang->nama_barang }}"
                                data-nama-pelapor="{{ $barang->nama_pelapor }}"
                                data-lokasi-penemuan="{{ $barang->lokasi_penemuan }}"
            ...
            @empty
                <tr>
                    <td colspan="9" class="py-4 px-4 text-center text-gray-500">Tidak ada data barang temuan.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
