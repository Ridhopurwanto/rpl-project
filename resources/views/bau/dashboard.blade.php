...
<div class="w-full">
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        {!! renderMenuButton('PRESENSI', route('bau.presensi.index')) !!}
        {!! renderMenuButton('PATROLI', route('bau.patroli.index')) !!}
        {!! renderMenuButton('KENDARAAN', route('bau.kendaraan.index')) !!}
        {!! renderMenuButton('TAMU', href: route('bau.tamu.index')) !!}
        {!! renderMenuButton('BARANG', href: route('bau.barang.index')) !!}
        {!! renderMenuButton('GANGGUAN KAMTIBMAS', href: route('bau.gangguan.index')) !!}
        {!! renderMenuButton('MANAJEMEN AKUN', href: route('bau.akun.index')) !!}
        {!! renderMenuButton('UNDUH LAPORAN', href: route('bau.unduh')) !!}
