    ...
    <div class="bg-gradient-to-b from-[#243a5e] via-[#2a4a6f] to-[#365c82] px-4 py-3">
        ...
        <div class="mb-6 bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200" 
            ...
            <div class="p-5 space-y-4">
                ...
                {{-- Alert Patroli Terlewat (pindahan dari atas) --}}
                @if(!empty($patroliExpired) && $patroliExpired)
                ...
                {{-- Countdown (hanya kalau belum waktunya dan tidak expired) --}}
                @if(empty($patroliExpired) || !$patroliExpired)
                ...
                {{-- Status & Tombol Claim --}}
                <div>
                    {{-- status selesai & berjalan sama seperti kode lama --}}
                    {{-- Tombol Claim: nonaktif jika patroliExpired --}}
                    @if(empty($patroliExpired) || !$patroliExpired)
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                    ...
                    <div x-show="showModal" @click.away="closeModal()"
                        ...
                        <vas x-ref="canvas" classs="hidden"></canvas>
