...
>
    ...
    {{-- ===== MODAL ALERT (AREA SUDAH DIKERJAKAN) ===== --}}
    <div x-show="showAlertModal" 
         @keydown.escape.window="showAlertModal = false"
        ...
        <div x-show="showAlertModal"
             ...
             class="fixed inset-0 bg-black bg-opacity-60 transition-opacity"></div>
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div x-show="showAlertModal"
                ...
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-center">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-2">Area Sudah Dikerjakan</h3>
                    <p class="text-blue-100 text-sm font-medium">Checkpoint telah diambil oleh anggota lain</p>
                </div>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                        <p class="text-xs text-slate-500 font-semibold uppercase mb-1">Wilayah</p>
                        <p class="text-lg font-bold text-slate-800" x-text="alertData.area"></p>
                    </div>
                    ...
                    <div class="flex items-center gap-3 bg-slate-50 rounded-xl p-4 border border-slate-200">
                        ...
                        <div class="flex-1">
                            <p class="text-xs text-slate-500 font-semibold uppercase">Dikerjakan oleh</p>
                            <p class="text-base font-bold text-slate-800" x-text="alertData.petugas"></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 bg-slate-50 rounded-xl p-4 border border-slate-200">
                        ...
                        <div class="flex-1">
                            <p class="text-xs text-slate-500 font-semibold uppercase">Waktu</p>
                            <p class="text-base font-bold text-slate-800 font-mono" x-text="alertData.waktu + ' WIB'"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 pb-6">
                    <button @click="showAlertModal = false" 
                            class="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-3.5 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02] active:scale-95">
                        OK, MENGERTI
                    </button>
                </div>
