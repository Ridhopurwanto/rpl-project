...
class ManajemenAkunController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('supervisor.akun.index')->with('success', 'Akun baru berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, $id_pengguna)
    {
        ...
        return redirect()->route('supervisor.akun.index')->with('success', 'Data akun berhasil diperbarui.');
    }
